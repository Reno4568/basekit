                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="example John Doe atau Jane" value="{{old('name')}}" autocomplete="off" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="find">Find Something <code style="color:red;">required</code></label>
                                                <input type="text" id="find" name="find" class="form-control" placeholder="Search Name or Email" value="{{isset($find) ? $find : ''}}" autocomplete="off" required>
