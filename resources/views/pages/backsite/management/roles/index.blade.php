                                                    ...
                                                    <tbody>
                                                        @forelse($roles as $key => $role)
                                                            <tr data-entry-id="{{ $role->id }}">
                                                                <td>{{ isset($role->created_at) ? date("d/m/Y H:i:s",strtotime($role->created_at)) : '' }}</td>
                                                                <td>{{ $role->title ?? '' }}</td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @endcan
                                                                            @can('role_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.roles.edit', $role->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan
                                                                            ...
                                                                            @if($role->id > 3)
                                                                                @can('role_delete')
                                                                                    <form action="{{ route('backsite.roles.destroy', $role->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
